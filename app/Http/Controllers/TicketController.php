...
class TicketController extends Controller
{
    ...
    public function supportTicket()
    {
        ...
        $openCount =  SupportTicket::where('status', 0)->where('user_id', Auth::id())->count();

        $supports = SupportTicket::where('user_id', Auth::id())->orderBy('priority', 'desc')->orderBy('id','desc')->paginate(getPaginate());
        return view($this->activeTemplate . 'user.support.index', compact('supports', 'pageTitle','openCount'));
    }
    ...
    public function supportOpenTicket()
    {
        if (!Auth::user()) {
            abort(404);
        }
        ...
        $supports = SupportTicket::where('status', 0)->where('user_id', Auth::id())->orderBy('priority', 'desc')->orderBy('id','desc')->paginate(getPaginate());
        return view($this->activeTemplate . 'user.support.index', compact('supports', 'pageTitle','openCount'));
    }
    ...
    public function viewTicket($ticket)
    {
        ...
        if (auth()->check()) {
            ...
            return view($this->activeTemplate. 'user.support.view-contact', compact('my_ticket', 'messages', 'pageTitle', 'user','layout'));
