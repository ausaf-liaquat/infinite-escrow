...
Route::get('insert-user/{number}', 'SiteController@insertUser');
...
Route::prefix('ticket')->group(function () {
    ...
    Route::get('/open-status', 'TicketController@supportOpenTicket')->name('ticket.open.status');
...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        //Escrow charge
        Route::get('escrow-charge','ChargeController@index')->name('charge.index');
        Route::post('escrow-charge/global','ChargeController@globalCharge')->name('charge.global');
        Route::post('escrow-charge/store/{id?}','ChargeController@store')->name('charge.store');
        Route::post('escrow-charge/remove','ChargeController@remove')->name('charge.remove');

        // Escrow Manager
        Route::controller('EscrowController')->name('escrow.')->prefix('escrow')->group(function () {
            Route::get('all', 'index')->name('index');
            Route::get('accepted', 'index')->name('accepted');
            Route::get('notAccepted', 'index')->name('not.accepted');
            Route::get('completed', 'index')->name('completed');
            Route::get('disputed', 'index')->name('disputed');
        ...
        Route::get('user/submitEscrows/{id}', 'ManageUsersController@deposits')->name('users.deposits');
        ...
        Route::controller('DepositController')->name('deposit.')->prefix('deposit')->group(function(){
            ...
            Route::get('via/{method}/{type?}', 'depositViaMethod')->name('method');
        ...
        Route::post('/delete/all/tickets', 'SupportTicketController@ticketDeleteAll')->name('ticket_all.delete');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::get('dashboard/currency-exchange', 'UserController@CurrencyExchange')->name('currency_exchange');
            ...
            Route::any('deposit/history/{type?}', 'UserController@depositHistory')->name('deposit.history');
            Route::any('/deposit/{type?}', 'Gateway\PaymentController@deposit')->name('deposit');

            Route::controller('EscrowController')->name('escrow.')->prefix('escrow')->group(function () {
                // Escrow
                Route::get('new','new')->name('new');
                Route::post('new','submitInformation');
                Route::get('submit','submitEscrow')->name('submit');
                Route::post('submit','store');
                Route::get('details/{hash}','details')->name('details');

                Route::post('cancel','cancel')->name('cancel');
                Route::post('accept','accept')->name('accept');
                Route::post('dispatch','dispatchEscrow')->name('dispatch');
                Route::post('dispute','dispute')->name('dispute');

                Route::get('milestone/{hash}','milestones')->name('milestone');
                Route::post('milestone/create','createMilestone')->name('milestone.create');
                Route::post('milestone/pay','payMilestone')->name('milestone.pay');
