                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="form-control-label font-weight-bold"> @lang('Charge Cap') <span class="text-danger">*</span> <code class="text--primary">(@lang('Keep 0 for no charge cap'))</code></label>
                            ...
                            <div class="form-group col-md-4">
                                <label class="form-control-label font-weight-bold"> @lang('Fixed Charge') <span class="text-danger">*</span> <code class="text--primary">(@lang('If the amount doesn\'t match any range'))</code></label>
                            ...
                            <div class="form-group col-md-4">
                                <label class="form-control-label font-weight-bold"> @lang('Percent Charge') <span class="text-danger">*</span> <code class="text--primary">(@lang('If the amount doesn\'t match any range'))</code></label>
                            ...
                            <tbody>
                                @forelse($charges as $charge)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Minimum')">{{ getAmount($charge->minimum) }} {{ $general->cur_text }}</td>
                                        <td data-label="@lang('Maximum')">{{ getAmount($charge->maximum) }} {{ $general->cur_text }}</td>
                                        <td data-label="@lang('Fixed Charge')">{{ getAmount($charge->fixed_charge) }} {{ $general->cur_text }}</td>
                                        <td data-label="@lang('Percent Charge')">{{ getAmount($charge->percent_charge) }} %</td>
                                        <td data-label="@lang('Action')">
                                            <button type="button" class="icon-btn cuModalBtn" data-resource="{{$charge}}" data-has_status="1" data-modal_title="@lang('Update Charge Range')"><i class="la la-pencil-alt"></i></button>

                                            <button type="button" class="icon-btn btn--danger removeBtn" data-id="{{$charge->id}}"><i class="las la-trash"></i></button>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                ...
                <form action="{{route('admin.charge.store')}}"  method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-control-label font-weight-bold">@lang('Minimum Amount') <span class="text-danger">*</span></label>
                            <div class="input-group has_append">
                        ...
                        <div class="form-group">
                            <label class="form-control-label font-weight-bold">@lang('Maximum Amount') <span class="text-danger">*</span></label>
                            <div class="input-group has_append">
                        ...
                        <div class="form-group">
                            <label class="form-control-label font-weight-bold">@lang('Percent Charge') <span class="text-danger">*</span></label>
                            <div class="input-group has_append">
