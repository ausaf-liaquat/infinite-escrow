                                ...
                                @foreach ($section->content as $k => $item)
                                    ...
                                    @elseif ($k == 'videos')
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label>Video</label>
                                                {{-- @dd($content->data_values) --}}
                                                <div class="image-upload">
                                                    <div class="thumb">
                                                        <div class="avatar-preview video_preview"
                                                            style="border: 3px solid #f1f1f1;
                                                        box-shadow: 0 0 5px 0 rgba(0, 0, 0, 0.25);
                                                        border-radius: 10px;">
                                                        <video src="{{ getImage('assets/images/frontend/' . $key . '/' . @$content->data_values->video, @$section->content->images->$imgKey->size) }}" width="600" height="295" controls></video>
                                                            {{-- <div class="profilePicPreview"
                                                                style="background-image: url({{ getImage('assets/images/frontend/' . $key . '/' . @$content->data_values->$imgKey, @$section->content->images->$imgKey->size) }})">
                                                                <button type="button" class="remove-image"><i
                                                                        class="fa fa-times"></i></button>
                                                        ...
                                                        <div class="avatar-edit">
                                                            <input type="file" class="profilePicUpload fileuploader"
                                                                name="video_input"
                                                                id="videoUploader{{ $loop->index }}">
                                                            <label
                                                            ...
                                                            transition: all 0.3s;"
                                                                class="bg--primary fileuploader-btn">Select a Video
                                                                File</label>
                                                            <small class="mt-2 text-facebook">Note:
                                                                Please upload a video that is less than<b> 6 MB</b>.
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $('.fileuploader').change(function() {
                ...
                if (fileSize > 6000000) {
                    alert('The selected file is too big. Please choose a video that is less than 6 MB.');
                    $(this).val('');
                } else {
                    reader.onload = function(file) {
                        ...
                        $('.video_preview').empty()
                        $('.video_preview').append('<video src="' + fileContent +
                            '" width="600" height="295" controls></video>');
                    }
