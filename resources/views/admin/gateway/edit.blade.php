                                                ...
                                                <div class="card border--primary mt-2">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="currency[{{ $currencyIdx }}][min_amount]" value="{{ getAmount($gatewayCurrency->min_amount) }}" placeholder="0"/>
                                                        </div>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0" name="currency[{{ $currencyIdx }}][max_amount]" value="{{ getAmount($gatewayCurrency->max_amount) }}"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card border--primary mt-2">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0" name="currency[{{ $currencyIdx }}][fixed_charge]" value="{{ getAmount($gatewayCurrency->fixed_charge) }}"/>
                                                        </div>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0" name="currency[{{ $currencyIdx }}][percent_charge]" value="{{ getAmount($gatewayCurrency->percent_charge) }}"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card border--primary mt-2">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input type="text" name="currency[{{ $currencyIdx }}][symbol]" class="form-control border-radius-5 symbl" value="{{ $gatewayCurrency->symbol }}" data-crypto="{{ $gateway->crypto }}"/>
                                                                </div>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="0" name="currency[{{ $currencyIdx }}][rate]" value="{{ getAmount($gatewayCurrency->rate) }}"/>
                                                            <div class="input-group-append">
                                                                ...
                                                                @foreach($parameters->where('global', false) as $key => $param)
                                                                    <div class="col-md-6">
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control" name="currency[{{ $currencyIdx }}][param][{{ $key }}]" value="{{ $gateway_parameter->$key }}" placeholder="---" />
                                                                        </div>
                                                                    </div>
                                                                @endforeach
                                                            </div>
                                        ...
                                        <div class="card border--primary mt-2">
                                            ...
                                            <div class="card-body">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input disabled type="text" class="form-control" name="currency[{{ $currencyIdx }}][min_amount]" placeholder="0"/>
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input disabled type="text" class="form-control" placeholder="0" name="currency[{{ $currencyIdx }}][max_amount]"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card border--primary mt-2">
                                            ...
                                            <div class="card-body">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input disabled type="text" class="form-control" placeholder="0" name="currency[{{ $currencyIdx }}][fixed_charge]" />
                                                </div>
                                                <div class="input-group">
                                                    <label class="w-100">@lang('Percent Charge')</label>
                                                    <div class="input-group-prepend">
                                                    ...
                                                    <input disabled type="text" class="form-control" placeholder="0" name="currency[{{ $currencyIdx }}][percent_charge]" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card border--primary mt-2">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input disabled type="text" class="form-control" placeholder="0" name="currency[{{ $currencyIdx }}][rate]"/>
                                                    <div class="input-group-append">
