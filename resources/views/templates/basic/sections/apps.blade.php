...
<div class="tilt-in-top-1 animation-element slide-left "  style="background-image: url({{url('')}}/assets/images/home.png);background-repeat: repeat-x;;">
    <div class="container aos-init" data-aos="zoom-out">
        ...
        controlslist="nodownload"
            ...
            <video class="iframCustom videoCustom" loop autoplay muted src="{{url('')}}/uploads/demo.mp4"></video>
            </div> 
            <div class="col-md-6" style="position: relative;top: -4px;">
                ...
                <p class="xxl-text fw-light text-center text-lg-start text--secondary appPara " style="font-size: 12px">
                   <img src="{{url('')}}/assets/images/app-1.png" alt="" style="background: #2d2d2d;"> Easy to Use <img src="{{url('')}}/assets/images/app-2.png" alt="" style="margin-left: 25px;background: #2d2d2d;"> Secured <img src="{{url('')}}/assets/images/app-3.png" alt="" style="margin-left: 25px;background: #2d2d2d;"> User friendly

                </p>
                <div class="row">
                    <div class="col-md-6 mt-3">
                        <a href="{{@$appsContent->data_values->play_store_link}}" class="t-link" target="_blank">
                            <img src="{{ getImage('assets/images/frontend/apps/'.@$appsContent->data_values->play_store_image,'200x60') }}" alt="escrow" class="img-fluid bg-white">
                        </a>
                    </div>
                    <div class="col-md-6 mt-3">
                        <a href="{{@$appsContent->data_values->apple_store_link}}" class="t-link" target="_blank">
                            <img src="{{ getImage('assets/images/frontend/apps/'.@$appsContent->data_values->apple_store_image,'200x60') }}" alt="escrow" class="img-fluid bg-white">
                        </a>
                    </div>
                </div>
