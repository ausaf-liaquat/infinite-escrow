                        ...
                        <div class="row">
                            <div class="col-md-12 mt-3">
                                <span>
                                    ...
                                    <br>
                                    {{ __($trx->currency_sym) }} {{ showAmount($trx->post_balance) }} 
                            ...
                            <div class="col-md-12">
                                ...
                                <span style="font-weight: 800;">
                                    <span class="font-weight-bold @if($trx->trx_type == '+') text--success @else text--danger @endif">
                                        {{ $trx->trx_type }} {{ $trx->currency_sym }} {{showAmount($trx->amount)}}
                                    </span>
                                </span>
                                <span class="float-right">
                                    {{ __($trx->details) }} {{ showDateTime($trx->created_at) }}<br>{{ diffForHumans($trx->created_at) }}
                                </span>
                            </div>
                            ...
                            <div class="col-md-12 mt-3">
                                @php
                                    if ($trx->trx_type == '+') {
                                        $previousBalance = $trx->post_balance - $trx->amount;
                                    } else {
                                        $previousBalance = $trx->post_balance + $trx->amount;
                                    }
                                ...
                                <span>
                                    ...
                                    <br>
                                    {{ __($trx->currency_sym) }} {{ showAmount($previousBalance) }}
