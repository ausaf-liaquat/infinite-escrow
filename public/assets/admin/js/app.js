      ...
      if (data.has_status) {
          ...
          cuModal.find(".status").html(`
                  <div class="form-group">
                      ...
                      <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="Enable" data-off="Disable" name="status">
                  </div>
              `);
